...
{
  cv::Mat color_image = cv::imread("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/color_part_align.png");
  ...
  cv::imwrite("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/leaf_node.png", color_image);
...
void quatree::showMergeLeafNodeImage()
{
  ...
  cv::imwrite("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/leaf_node_merge.png", color_image);
  cv::imshow("leaf node", color_image);
  cv::waitKey(0);
}
...
void quatree::showSeedNodeAndNeighbors()
{
  ...
  cv::imwrite("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/seed_node.png", color_image);
  cv::waitKey(0);
  ...
  cv::imwrite("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/merge_step.png", color_image);
  cv::waitKey(0);
}
