...
struct FootParam // 这是针对机器人的脚的参数，机器人不一样，脚的参数就会不一样
{
 ...
 */
class AstarHierarchicalFootstepPlannerBase
{
protected:
...
public:
    AstarHierarchicalFootstepPlannerBase();
    /**
     ...
     * @param hip_width_ 髋宽 
     */
    // AstarHierarchicalFootstepPlannerBase(grid_map::GridMap & lm, FootParam footparam_, double hip_width_);
     ...
     * @return false 
     */
    virtual bool computeLandInfo(Eigen::Vector3d ankle, int & max_size, int & above_points, Eigen::Vector3d & plane_normal, double & step_height, int & plane_index, double & pitch, double & roll) = 0;
    ...
    virtual ~AstarHierarchicalFootstepPlannerBase();
};
