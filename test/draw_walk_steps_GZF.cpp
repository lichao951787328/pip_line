...
{
  draw_image = cv::imread("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/walk_step_GZF/segmented_result_2.png");
  ...
  cv::waitKey(0);
  cv::imwrite("/home/humanoid/work/plane_detection/catkin_plane_detection_test_ws/src/plane_detection/bag/walk_step_GZF/planed_steps.png", draw_image);
  return 0;
}